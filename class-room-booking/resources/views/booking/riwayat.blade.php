<x-layouts.app title="Riwayat Peminjaman">
    <div class="p-6">
        <h2 class="text-3xl font-bold text-center text-blue-800 mb-2">📜 Riwayat Peminjaman</h2>
        <p class="text-center text-sm text-gray-500 mb-6">Data semua peminjaman ruangan oleh mahasiswa</p>
        ...
        <form method="GET" class="mb-6 flex flex-wrap items-center justify-between gap-3">
            ...
            <a href="{{ route('booking.riwayat') }}" class="text-sm text-blue-600 underline ml-auto">
                🔄 Reset
            </a>
        </form>
